...
- Choose complete 2023–2025 reports or a clearly labelled 2026 year-to-date report.
- View estimated total rainfall and average temperature for the selected year.
- Compare complete annual rainfall and temperature with an adjacent available year.
...
The current datasets cover complete years from 2023–2025 and a 2026 year-to-date period ending 18 August 2026. They contain:
...
```powershell
python .\scripts\fetch_power_data.py --year 2023 --year 2024 --year 2025 --year 2026
```
...
```powershell
python .\scripts\process_power_data.py --year 2023 --year 2024 --year 2025 --year 2026
```
...
The data download and processing pipeline is working and covered by automated unit tests. The deployed website can load, compare and explain complete 2023–2025 monthly rainfall and temperature data for four locations. It also presents 2026 observations through 18 August as year-to-date data without comparing the partial totals against complete years. Browser coverage runs at desktop and mobile sizes. Development is continuing incrementally so that each part is understood before more complexity is added.
